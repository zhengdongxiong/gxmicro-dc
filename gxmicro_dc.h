...
#define FRAME_BUFFER_FORMAT		GENMASK(2, 0)
...
/* HVDisplay & HVSync  */
#define HVDISPLAY_TOTAL(t)		(((t) & 0x7ff) << 16)
#define HVDISPLAY_END(e)		((e) & 0x7ff)
...
#define JPEG_MAX_PCLK			74250000	/* 1920 x 1080 x 30Hz, pclk (1080p 60Hz) / 2 */
...
static inline void gxmicro_write(struct gxmicro_dc_dev *gdev, uint32_t reg, uint32_t value)
{
	iowrite32(value, gdev->mmio + reg);
}
